...
/--
One-hop extraction from singleton handler-level resume bundle to the concrete
clause summary contract.
-/
theorem singletonHandleContract_handlerResumeAtMostOnce
    (clause : HandleClauseContract)
    (h_bundle :
      HandleClauseContract.HandlerResumeLinearityBundle (singletonHandleContract clause)) :
    resume_at_most_once clause.resumeUse := by
  have h_comp :
      HandleClauseContract.HandlerResumeLinearityBundleComponents
        (singletonHandleContract clause) :=
    HandleClauseContract.handlerResumeLinearityBundle_as_components
      (singletonHandleContract clause) h_bundle
  have h_mem : clause ∈ (singletonHandleContract clause).clauses := by
    simp [singletonHandleContract]
  rcases h_comp clause h_mem with ⟨u, h_summary, h_atMostOnce⟩
  have h_clause_summary :
      HandleClauseContract.clauseHasResumeSummary clause u :=
    HandleClauseContract.handlerClauseHasResumeSummary_clauseSummary
      (singletonHandleContract clause) clause u h_summary
  have h_eq : u = clause.resumeUse :=
    HandleClauseContract.clauseHasResumeSummary_eq_resumeUse
      clause u h_clause_summary
  subst h_eq
  exact h_atMostOnce

/-- Direct singleton handler-level `resume_at_most_once` from `wellTypedSlice`. -/
theorem effectHandler_handlerResumeAtMostOnce_of_wellTyped
    (clause : HandleClauseContract)
    (h_wellTyped : HandleClauseContract.wellTypedSlice clause) :
...
theorem effectHandlerSuite_handlerResumeAtMostOnce_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
    ...
    (_h_lowered :
      _loweredTy =
        FailResultContracts.lowerFailFunctionType
          ...
          _errTy) :
    resume_at_most_once clause.resumeUse :=
  effectHandler_handlerResumeAtMostOnce_of_wellTyped clause h_wellTyped
...
theorem effectHandlerSuite_handlerResumeAtMostOnce_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
/--
Premise-route wrapper: extract singleton handler-level packaged linearity along
the route used to build `EffectHandlerCapstoneSuite`.
-/
def effectHandlerCapstoneSuite_handlerResumeLinearityBundle_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCapstoneSuite_handlerResumeLinearityBundle_as_components_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCapstoneSuite_handlerResumeAtMostOnce_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
/--
Fail-present route wrapper for singleton handler-level packaged linearity on
`EffectHandlerCapstoneSuite`.
-/
def effectHandlerCapstoneSuite_handlerResumeLinearityBundle_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCapstoneSuite_handlerResumeLinearityBundle_as_components_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCapstoneSuite_handlerResumeAtMostOnce_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
/--
Premise-route wrapper for singleton handler-level packaged linearity on
`EffectHandlerCatchPairSuite`.
-/
def effectHandlerCatchPairSuite_handlerResumeLinearityBundle_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCatchPairSuite_handlerResumeLinearityBundle_as_components_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCatchPairSuite_handlerResumeAtMostOnce_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
`EffectHandlerCatchPairSuite`.
-/
def effectHandlerCatchPairSuite_handlerResumeLinearityBundle_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCatchPairSuite_handlerResumeLinearityBundle_as_components_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCatchPairSuite_handlerResumeAtMostOnce_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
-/
def effectHandlerCompositionSuite_handlerResumeLinearityBundle_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCompositionSuite_handlerResumeLinearityBundle_as_components_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCompositionSuite_handlerResumeAtMostOnce_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
`EffectHandlerCompositionSuite`.
-/
def effectHandlerCompositionSuite_handlerResumeLinearityBundle_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCompositionSuite_handlerResumeLinearityBundle_as_components_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCompositionSuite_handlerResumeAtMostOnce_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
-/
def effectHandlerCompositionCoherenceSuite_handlerResumeLinearityBundle_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCompositionCoherenceSuite_handlerResumeLinearityBundle_as_components_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCompositionCoherenceSuite_handlerResumeAtMostOnce_of_premises
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
`EffectHandlerCompositionCoherenceSuite`.
-/
def effectHandlerCompositionCoherenceSuite_handlerResumeLinearityBundle_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCompositionCoherenceSuite_handlerResumeLinearityBundle_as_components_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
theorem effectHandlerCompositionCoherenceSuite_handlerResumeAtMostOnce_of_fail_present
    (clause : HandleClauseContract)
    (_baseEffects : EffectRow)
    (_capability : Label)
    (_innerEffects : EffectRow)
...
/--
Aggregate disjoint-target composition coherence suite at the Phase-2 contract
layer. This exposes nested disjoint coherence through the same top-level module
as other handler composition packages.
-/
structure EffectHandlerDisjointCompositionCoherenceSuite
...
/-- Explicit component alias for disjoint-target composition coherence suite. -/
abbrev EffectHandlerDisjointCompositionCoherenceSuiteComponents
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label) : Prop :=
  NestedHandlerCompositionContracts.NestedHandlerDisjointCoherence
    effects handlerA handlerB targetA targetB

theorem effectHandlerDisjointCompositionCoherenceSuite_iff_components
    (effects handlerA handlerB : EffectRow)
  ...
  constructor
  · intro h_suite
    exact h_suite.nestedDisjoint
  · intro h_comp
    exact { nestedDisjoint := h_comp }

theorem effectHandlerDisjointCompositionCoherenceSuite_of_components
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_comp :
      EffectHandlerDisjointCompositionCoherenceSuiteComponents
...
theorem effectHandlerDisjointCompositionCoherenceSuite_as_components
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_suite :
      EffectHandlerDisjointCompositionCoherenceSuite effects handlerA handlerB targetA targetB) :
...
theorem effectHandlerDisjointCompositionCoherenceSuite_as_components_of_components
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_comp :
      EffectHandlerDisjointCompositionCoherenceSuiteComponents
...
theorem effectHandlerDisjointCompositionCoherenceSuite_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    ...
    EffectHandlerDisjointCompositionCoherenceSuite effects handlerA handlerB targetA targetB := by
  exact {
    nestedDisjoint :=
      NestedHandlerCompositionContracts.nestedHandlerDisjointCoherence_of_handler_absence
        effects handlerA handlerB targetA targetB
        h_targets_ne
...
theorem effectHandlerDisjointCompositionCoherenceSuite_as_components_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointCompositionCoherenceSuite_nestedDisjoint_as_components
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_suite :
      EffectHandlerDisjointCompositionCoherenceSuite effects handlerA handlerB targetA targetB) :
    NestedHandlerCompositionContracts.NestedHandlerDisjointCoherenceComponents
      effects handlerA handlerB targetA targetB :=
...
theorem effectHandlerDisjointCompositionCoherenceSuite_labelObservationalEq_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
    ...
    EffectRow.LabelObservationalEq
      ...
      (NestedHandlerCompositionContracts.nestedComposeDisjointSwap
        effects handlerA handlerB targetA targetB) :=
  NestedHandlerCompositionContracts.nestedHandlerDisjointLabelObservationalEq_of_handler_absence
    effects handlerA handlerB targetA targetB
    h_targets_ne
    h_handlerA_abs_targetA
    h_handlerA_abs_targetB
...
theorem effectHandlerDisjointCompositionCoherenceSuite_restEq_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointCompositionCoherenceSuite_hasEq_of_handler_absence
    (effects handlerA handlerB : EffectRow)
...
theorem effectHandlerDisjointCompositionCoherenceSuite_nestedDisjoint_as_components_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointObservationalSuite_nestedDisjoint_as_components
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_suite :
      EffectHandlerDisjointObservationalSuite effects handlerA handlerB targetA targetB) :
...
theorem effectHandlerDisjointObservationalSuite_restEq
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_suite :
      EffectHandlerDisjointObservationalSuite effects handlerA handlerB targetA targetB) :
    ...
    EffectRow.rest
      (NestedHandlerCompositionContracts.nestedComposeDisjointSwap
        effects handlerA handlerB targetA targetB) :=
  (effectHandlerDisjointObservationalSuite_observationalEq
    effects handlerA handlerB targetA targetB h_suite).1

theorem effectHandlerDisjointObservationalSuite_hasEq
    (effects handlerA handlerB : EffectRow)
    (targetA targetB label : Label)
    (h_suite :
      EffectHandlerDisjointObservationalSuite effects handlerA handlerB targetA targetB) :
    ...
    RowFields.has
      ...
      label :=
  (effectHandlerDisjointObservationalSuite_observationalEq
    effects handlerA handlerB targetA targetB h_suite).2 label

theorem effectHandlerDisjointObservationalSuite_coherence_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointObservationalSuite_nestedDisjoint_as_components_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointObservationalSuite_observationalEq_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointObservationalSuite_restEq_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointObservationalSuite_hasEq_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB label : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
  ...
  effectHandlerDisjointObservationalSuite_hasEq
    effects handlerA handlerB targetA targetB label
    (effectHandlerDisjointObservationalSuite_of_handler_absence
      effects handlerA handlerB targetA targetB
      h_targets_ne
      h_handlerA_abs_targetA
...
theorem effectHandlerDisjointObservationalSuite_leftTargetAAbsent_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointObservationalSuite_leftTargetBAbsent_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointObservationalSuite_rightTargetAAbsent_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointObservationalSuite_rightTargetBAbsent_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointObservationalSuite_leftRowTailStable_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
...
theorem effectHandlerDisjointObservationalSuite_rightRowTailStable_of_handler_absence
    (effects handlerA handlerB : EffectRow)
    (targetA targetB : Label)
    (h_targets_ne : targetA ≠ targetB)
    (h_handlerA_abs_targetA : RowFields.has (EffectRow.fields handlerA) targetA = false)
