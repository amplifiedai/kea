...
- **[Const fields](in-progress/const-fields.md)** — Active. `const` fields in structs per KERNEL §2.9. Module-level constants, const patterns, immortal refcount for heap consts. Strict subset (literals/refs/constructors/primitive ops) for Phase 0.
