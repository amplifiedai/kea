...
- **[Callback stacking](design/callback-stacking.md)** (post-v1) — LIFO post-resume chain for multi-yield non-tail handlers. Fixes "last invocation wins" limitation of Tier 4 clause body splitting. ~50-100 LOC in MIR lowering. Needed for generators, backtracking, coroutines.
