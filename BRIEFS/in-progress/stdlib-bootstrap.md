...
- **Next:** add `Log.with_collected_logs` once list-accumulation ergonomics for handler-local collection are finalized, then expand Tier-1 execute-path stdlib tests around helper combinators.
