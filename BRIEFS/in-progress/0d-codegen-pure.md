...
- **Next:** Close remaining 0d runtime/codegen delta: structs/enums data layout + lowering, pattern coverage beyond literal/unit-enum fast path, and actual Fail-only Result lowering path (invariant enforcement is now in place).
