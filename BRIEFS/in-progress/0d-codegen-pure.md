...
- **Next:** Continue the remaining 0d runtime/codegen delta by expanding struct/enum runtime lowering beyond handle-only carriers and closing outstanding parser/runtime gaps listed in §7-§9 (`Maybe Int` param annotations, `Never`, `catch` wiring).
