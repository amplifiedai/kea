...
- **Next:** Close remaining 0d runtime/codegen delta: structs/enums data layout + lowering, pattern coverage beyond literal/unit-enum fast path, and Fail-only Result lowering/codegen invariant work.
