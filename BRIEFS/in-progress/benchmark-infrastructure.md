...
- **Next:** Record and publish first whole-program baseline artifacts, then use CI variance artifacts to set initial Stage B regression thresholds (wide bands first) before enabling threshold checks in non-blocking mode.
