...
- **Next:** Use CI variance + whole-program baseline artifacts to set initial Stage B regression thresholds (wide bands first), then enable threshold checks in non-blocking mode before switching to blocking gates.
