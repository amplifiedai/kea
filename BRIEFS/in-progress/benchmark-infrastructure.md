...
- **Next:** Use CI variance history (not just local runs) to decide whether additional benchmark classes can graduate from non-blocking Stage B into the stable blocking set.
