...
- **Next:** Implement explicit prelude trait/type in-scope behavior (unqualified dispatch) and tighten module visibility metadata in preparation for stdlib bootstrap.
