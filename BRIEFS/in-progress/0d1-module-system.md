...
- **Next:** Implement Step 4 struct-everything module wiring (implicit module struct registration + top-level function-as-inherent method plumbing) and extend the resolution matrix with those method paths.
