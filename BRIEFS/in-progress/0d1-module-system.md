...
- **Next:** fold same-name module-struct method behavior into the resolution matrix (import-state/call-form table) so UMS policy expectations are explicit there, then finish remaining 0d1 DoD checks and closeout.
