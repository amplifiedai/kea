...
- **Next:** Wire hardcoded prelude re-export list for unqualified names (`Ordering`, `Some`/`None`, etc.) and keep metadata plumbing ready for post-bootstrap `pub` enforcement.
