...
- **Next:** continue 0e runtime-effects critical path with broader handler execution coverage (beyond tail-resumptive `State`) and keep `kea test` aligned as effect features land.
