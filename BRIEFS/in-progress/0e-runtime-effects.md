...
- **Next:** keep the 0e runtime lane on evidence-dispatch depth: tighten multi-operation handler coverage and extend compiled-path tests for handler composition/nesting beyond current smoke coverage.
