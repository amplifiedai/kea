...
- **Next:** harden capability-direct runtime shims for `IO.read_file` / `IO.write_file` and add regression coverage for direct-effect argument validation/diagnostics in codegen.
