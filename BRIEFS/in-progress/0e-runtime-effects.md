...
- **Next:** continue the 0e evidence-dispatch lane by adding explicit compiled-path coverage for the remaining composition edges: handler bodies performing different effects and handled-effect re-perform routing to outer handlers.
