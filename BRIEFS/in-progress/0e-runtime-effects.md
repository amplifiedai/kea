...
- **Next:** continue Step 2 capability-direct expansion with initial `Net` operations (`connect`, `send`, `recv`) plus stdlib module + integration tests, while preserving wrapper-free effect-module imports.
