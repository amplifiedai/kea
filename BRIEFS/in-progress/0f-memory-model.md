...
- **Next:** Reassess whether to introduce explicit MIR `ReuseToken` flow for loop-carried / non-tail pairings now that same-block + cross-block join fusion paths are covered.
