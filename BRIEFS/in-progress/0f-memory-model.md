...
- **Next:** continue Step 6 by wiring fixed-width execute-path coverage in codegen/MIR (lowering `IntN/UIntN` values) and validating narrowing-explicit behavior end-to-end.
