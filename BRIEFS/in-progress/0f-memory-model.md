...
- **Next:** Continue Step 3d by extending reuse pairing beyond record layouts (sum constructors / explicit token flow) and wiring `reuse_count` into benchmark artifacts.
