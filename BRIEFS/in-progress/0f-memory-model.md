...
- **Next:** extend Step 2 with borrow escape checks (return/store/capture rejection) and broaden borrow metadata propagation for cross-module/qualified call targets.
