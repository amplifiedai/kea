...
- **Next:** Extend Step 3e beyond descending-int chain rewrites (general constructor contexts / field expression support) and pair it with Step 3c follow-up on deep recursive drop lowering to avoid runtime SIGSEGV on very large recursive sum teardown.
