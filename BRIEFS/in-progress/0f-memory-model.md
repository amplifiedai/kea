...
- **Next:** Step 3c — drop specialization. Generate per-type drop lowering so recursive heap types inline uniqueness checks and field drops, enabling Step 3d reuse-token pairing (Perceus FBIP).
