...
- **Next:** extend Step 3 beyond release scheduling: detect linear consume opportunities and fuse obvious retain/release churn patterns (with allocation-count regressions) while keeping reuse strictly optimization-only.
