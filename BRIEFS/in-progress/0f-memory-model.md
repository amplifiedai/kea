...
- **Next:** Add at least one source kernel that lowers to `RecordInitFromToken`/`SumInitFromToken` (non-zero consumed coverage), then pin that as the first CI conversion-rate floor.
