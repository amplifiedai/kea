...
- **Next:** add allocation-count-focused regressions for real programs to quantify churn reduction and continue Step 3 toward linear-use-driven reuse candidates (beyond retain/release pair fusion).
