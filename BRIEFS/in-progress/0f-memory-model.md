...
- **Next:** continue Step 6 fixed-width path with mixed-width arithmetic coercion rules and execute-path coverage (widening implicit, narrowing explicit) for `Int8..Int64`/`UInt8..UInt64`.
