...
- **Next:** Implement the first Step 3e rewrite slice (single-block constructor-under-self-call TRMC lowering) and add a benchmark proving stack-safe execution at depth >= 1M on the compiled path.
