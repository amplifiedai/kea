...
- **Next:** close remaining Step 6 edges (broader non-`Int` conversion inputs + additional conversion diagnostics) and then begin Step 1 move-checking pass skeleton.
