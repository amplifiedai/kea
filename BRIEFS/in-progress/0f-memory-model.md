...
- **Next:** continue Step 3 with non-trivial linear-use windows (beyond nop-only separation) and add allocation-count-focused regressions to show measurable churn reduction.
