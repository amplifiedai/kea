...
- **Next:** continue Step 6 fixed-width path by tightening conversion + overflow diagnostics for `Int8..Int64`/`UInt8..UInt64` (literal fit + operation result diagnostics) and adding execute-path coverage for mixed-width arithmetic coercions.
