...
- **Next:** Extend Step 3d cross-block reuse beyond jump-only/single-predecessor cases (branch-join token flow), then reassess whether explicit MIR reuse tokens are still needed.
