...
- **Next:** continue Step 3 toward linear-use-driven reuse candidates (beyond retain/release pair fusion), with additional stats-backed regressions on allocation-heavy kernels.
