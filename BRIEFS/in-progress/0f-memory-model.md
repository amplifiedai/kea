...
- **Next:** finish Step 6 by adding explicit narrowing-conversion surface (`try_from`/checked casts for fixed-width ints) and end-to-end overflow diagnostics on conversion paths.
