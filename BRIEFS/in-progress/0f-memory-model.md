...
- **Next:** Wire `reuse_count` into benchmark artifacts (summary export + regression visibility), then evaluate whether to introduce explicit MIR reuse tokens for cross-block pairing.
