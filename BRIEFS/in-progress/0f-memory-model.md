...
- **Next:** Step 3d — reuse tokens (Perceus FBIP). Add MIR-level release/alloc pairing and token consumption to eliminate allocator churn for structure-preserving recursive transforms.
