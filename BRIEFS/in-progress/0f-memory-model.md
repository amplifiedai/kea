...
- **Next:** Add source-level kernels that actually trigger token consumption on compiled paths (not just candidate reporting), then pin expected non-zero coverage bands in benchmark artifacts/CI.
