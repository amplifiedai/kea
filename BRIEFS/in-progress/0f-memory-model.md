...
- **Next:** continue Step 3 with non-adjacent linear-use reuse opportunities (safe retain/release sinking/fusion over short windows) and add allocation-count-focused regressions to show measurable churn reduction.
