...
- **Next:** Extend Step 3e beyond the current descending-int family (non-trivial recursive argument shapes / broader constructor contexts) and pair it with the Step 3c deep-recursive drop follow-up to avoid runtime SIGSEGV on very large recursive sum teardown.
