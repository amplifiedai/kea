...
- **Next:** Add/expand benchmark kernels that exercise loop/back-edge token flow in source-level programs, then set a baseline conversion-rate trend (candidate vs consumed) in benchmark artifacts.
