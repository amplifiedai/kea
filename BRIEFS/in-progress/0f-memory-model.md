...
- **Next:** continue Step 3 with additional linear-use candidate patterns beyond direct var-alias lets (e.g. single-use tuple/record carriers), then extend stats-backed regressions on allocation-heavy kernels.
