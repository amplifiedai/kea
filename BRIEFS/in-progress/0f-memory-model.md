...
- **Next:** Continue Step 3d by broadening reuse pairing beyond adjacent record init sites (sum layouts + non-adjacent token flow) and adding pass stats/bench visibility for reuse hit rate.
