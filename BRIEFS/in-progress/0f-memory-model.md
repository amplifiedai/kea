...
- **Next:** Add a conservative MIR rewrite pass that emits token-flow ops automatically for loop-carried/non-tail release→alloc pairings (starting with jump-back edge patterns), then benchmark candidate-to-consumed conversion rates.
