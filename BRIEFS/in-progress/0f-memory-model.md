...
- **Next:** continue Step 6 by adding integer bit-count methods (`popcount`, `leading_zeros`, `trailing_zeros`) and fixed-width conversion/overflow diagnostic coverage.
