...
- **Next:** connect admissibility-gated polymorphism contracts to concrete `catch`/handler typing judgments as explicit theorem entrypoints (runtime-aligned by construction).
