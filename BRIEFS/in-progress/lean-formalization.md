...
- **Next:** extend `FailResultContracts` from contract-level lowering to explicit Fail/Result typing equivalence slices, then start effect-polymorphism soundness surfaces.
