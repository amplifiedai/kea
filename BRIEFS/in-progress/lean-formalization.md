...
- **Next:** continue tightening the judgment-surface API by adding one-hop projections from `catchTypingJudgment_sound_of_premises` and bundle-of-premises helpers, minimizing downstream destructuring.
