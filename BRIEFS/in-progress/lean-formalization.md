...
- **Next:** evaluate whether remaining Phase-2 claims (Fail/Result equivalence, effect-polymorphism soundness) need any additional MCP re-probe classes before marking this slice stable.
