...
- **Next:** lift normalized composition from single-handle rows to nested-handler composition theorems and begin resume-linearity theorem scaffolding, while keeping the implementation overlap-normalization divergence explicitly tracked until dedup lands.
