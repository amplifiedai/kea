...
- **Next:** extend the admissible capstone surface with explicit projections for row-tail stability and non-Fail label preservation to support downstream theorem chaining in one-hop form.
