...
- **Next:** extend `CatchTypingBridge` with named bundle outputs/projections matching the `EffectPolymorphismSoundness` bundle ergonomics, so judgment-level consumers also get one-name theorem surfaces.
