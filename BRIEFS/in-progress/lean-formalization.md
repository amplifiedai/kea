...
- **Next:** add direct theorem adapters from existing handler typing slices into `AdmissibleEffectPolyHandlerSchema` constructors to reduce setup boilerplate at call sites.
