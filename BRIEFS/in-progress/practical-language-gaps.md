...
**Blocks:** 0g (gaps 7+8 are prerequisites), Phase 1 (self-hosting)
...
## ~~Gap 6: IO Decomposition in Runtime~~ DONE

Clock, Net, Rand all have separate effect rows, separate stdlib
declarations (`stdlib/clock.kea`, `stdlib/net.kea`, `stdlib/rand.kea`),
and separate runtime handler implementations in kea-codegen.
