...
- **Next:** Continue 0d/0e adversarial gaps by implementing compiled-lowering support for function-valued effect operations / nested lambda-returning-lambda (the diagnostics are now explicit and stable).
