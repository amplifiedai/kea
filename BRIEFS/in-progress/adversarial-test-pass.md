...
- **Next:** Continue 0d/0e adversarial gaps by either implementing compiled-lowering support for function-valued effect operations / nested lambda-returning-lambda, or upgrading those current backend errors to explicit user-facing diagnostics in type/lowering phases.
