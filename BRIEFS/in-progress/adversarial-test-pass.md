...
- **Next:** Continue 0d/0e adversarial expansion with additional closure/handler and nested-handler stress cases that currently have no dedicated sad-path coverage.
