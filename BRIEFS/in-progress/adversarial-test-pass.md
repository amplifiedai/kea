...
- **Next:** Continue 0d/0e adversarial expansion with additional closure/handler and nested-handler stress cases; then decide whether to implement or explicitly brief the new handler-then + outer-catch lowering gap.
