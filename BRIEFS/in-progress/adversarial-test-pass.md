...
- **Next:** Continue 0c handler-scoping violations (mismatched handled effect and empty handler block behavior), then extend 0a malformed-input matrix to keyword-as-identifier and CRLF/whitespace edge cases.
