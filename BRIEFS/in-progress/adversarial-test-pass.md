...
- **Next:** Extend 0a malformed-input matrix to keyword-as-identifier and CRLF/whitespace edge cases; then continue 0b/0d adversarial gaps (trait coherence edge cases and closure/RC stress).
