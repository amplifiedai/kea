...
- **Next:** Continue 0b/0d adversarial gaps: trait signature compatibility checks (e.g. impl return-type mismatch against trait method contract) and additional closure/RC stress.
