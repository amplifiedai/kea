...
- **Phase 2 (active):** Added `Kea/Properties/HandlerClosedAwareContracts.lean` to lift absent-effect no-op semantics into clause-level APIs (`resultEffectsCoreClosedAware`, `resultEffectsClosedAware`, and normalized/closed-case bridge theorems).
