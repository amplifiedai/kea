...
//   kea_active_prompt_get() -> *mut Prompt
//   kea_active_prompt_set(*mut Prompt) -> ()
...
kea_fiber_trampoline:
    ...
    call kea_active_prompt_set    // r12-r15 intact (callee-saved)
    ...
    xor  %rdi, %rdi
    call kea_active_prompt_set    // r12, r14 intact
...
kea_fiber_suspend:
    ...
    call kea_active_prompt_get    // rax = prompt; [rsp] intact (callee restores rsp)
...
kea_fiber_resume:
    ...
    // Set ACTIVE_PROMPT = prompt (rdi already = prompt)
    call kea_active_prompt_set    // r12, r13 intact
